...
HADOOP_PREFIX = "/home/user/%s" % HADOOP_PACKAGE
...
SPARK_PREFIX = "/home/user/%s" % SPARK_PACKAGE
...
ENVIRONMENT_FILE = "/home/user/.bashrc"
...
NAMENODE_HOST = "TestMain"
RESOURCEMANAGER_HOST = "TestMain"
SLAVE_HOSTS = ["TestWorker", "TestMain"]
# for Storm installation:
NIMBUS_HOST = "TestMain"
