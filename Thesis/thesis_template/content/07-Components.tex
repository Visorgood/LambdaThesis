...
The Storm cluster has a master node called Nimbus and worker nodes.
Nimbus assignes tasks for workers and monitors failures.
There is a deamon called Supervisor on every worker node.
...
The basic concept of Storm is a topology.
...
The following code represents a simple topology.
