...
The probability of a failure is complex and difficult to compute.
Google has made deep research on this topic, and has found out that ...... \cite{Pinheiro2007}.
This statistic shows that there are always machines in the large cluster, that are out of service.
Because of that, fault-tolerance, detecting of failed machines and recovering from unconsistent state of the file system are inherent properties of HDFS.
...
HDFS architecture lets to have high overall bandwidth working with them.
...
\subsubsection{Alternative. Google File System}
