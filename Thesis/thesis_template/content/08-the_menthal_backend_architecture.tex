...
% проверить главу про speed layer, есть ли там уже эти названия?
...
As a result, it should meet the following two requirements.
% as menthal uses heteregeneous architecture, it has to be well defined and documented - as a topic sentence
...
% devide into two paragraphs
% similarly, the fitures must be well documented
\mnote{Documentation}
...
\mnote{Extensibility}
% the system must be easy to extend by additional functionalities.
...
% add examples - what if tuple is illegal
...
% summary - tradeoff between smth, new, old, from real-time programming, from distributed systems, easy, hard
...
\authorsection{Aspects od implementation}{NO}
