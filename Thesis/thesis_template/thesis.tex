...
\input{content/02-The_menthal_story}
\input{content/03-Big_data_architecture}
\input{content/04-Industrial_approaches}
\input{content/06-Real_time_processing_in_the_big_data_context}
\input{content/05-Lambda_architecture}
\input{content/07-Components}
\input{content/08-Menthal_backend_architecture}
\input{content/10-experiments}
\input{content/11-Summary}
